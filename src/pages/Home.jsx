        ...
        <div class='bg-natural-200 px-6 py-12 text-center dark:bg-neutral-900 md:px-12 lg:text-left'>
          <div class='w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl'>
            <div class='grid items-center gap-12 lg:grid-cols-2 mt-20'>
              <div class=' lg:mt-0'>
                <h1 class='mt-2 text-white mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl'>
                  यवतमाळ जिल्हा क्रीडा संकुल समिती, यवतमाळ <br />
                  {/* <span class='text-white  text-sm'>for your business</span> */}
                </h1>
                ...
                <Link to='/batches'>
                  ...
                  >
                    <button
                      type='button'
                      class='text-white flex gap-2 items-center w-full bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'
                    >
              ...
              <div class='mb-12 lg:mb-0'>
                <img
                  ...
                  class='w-full h-[70vh] rounded-lg shadow-lg dark:shadow-black/20'
                  alt=''
                />
              </div>
            </div>
