          ...
          <div className='mt-8 grid lg:grid-cols-2 gap-4'>
            ...
            <div className=' flex gap-7 items-center'>
              ...
              >
                ...
                <option className=' capitalize font-semibold' value='female'>
                  female
                </option>
          ...
          >
            ...
            <div className=' px-2 py-4 flex items-center justify-evenly'>
              <div>
                ...
                <Link>
                  <div className=' bg-green-400 text-gray-700  px-4 rounded-lg py-2 text-lg font-semibold cursor-pointer hover:bg-green-500 transition-all ease-in-out duration-300'>
